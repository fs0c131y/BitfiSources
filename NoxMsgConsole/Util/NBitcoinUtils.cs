...
namespace NoxMsgConsole.Util
{
    ...
    public class VarInt : IBitcoinSerializable
    {
        ...
        {
            this._Value = value;
            if (_Value \                _PrefixByte = (byte)(int)_Value;
            else if (_Value \                _PrefixByte = 0xFD;
            else if (_Value \                _PrefixByte = 0xFE;
            else
                _PrefixByte = 0xFF;
        }
        public ulong ToLong()
        ...
        public void ReadWrite(BitcoinStream stream)
        {
            ...
            else
            {
                ...
                while (true)
                {
                    ...
                    ulong a = (n \                    byte b = (byte)(chData & 0x7F);
                    n = (a | b);
                    if ((chData & 0x80) != 0)
                        n++;
                    else
    ...
    public static class BitcoinSerializableExtensions
    {
        ...
        public static T Clone\\(this T serializable, ProtocolVersion version = ProtocolVersion.PROTOCOL_VERSION) where T : IBitcoinSerializable, new()
        {
            var instance = new T();
    ...
    public partial class BitcoinStream
    {
        ...
        public T ReadWrite\\(T data) where T : IBitcoinSerializable
        {
            ReadWrite\\(ref data);
            return data;
        }
        ...
        public void ReadWriteStruct\\(ref T data) where T : struct, IBitcoinSerializable
        {
            data.ReadWrite(this);
        }
        public void ReadWriteStruct\\(T data) where T : struct, IBitcoinSerializable
        {
            data.ReadWrite(this);
        }
        public void ReadWrite\\(ref T data) where T : IBitcoinSerializable
        {
            var obj = data;
            if (obj == null)
        ...
        public void ReadWrite\\(ref List\\ list) where T : IBitcoinSerializable, new()
        {
            ReadWriteList\\, T\>\(ref list);
        }
        public void ReadWrite\\(ref TList list)
            where TList : List\\, new()
            where TItem : IBitcoinSerializable, new()
        {
            ReadWriteList\\(ref list);
        }
        ...
        public void ReadWrite\\(ref T[] arr) where T : IBitcoinSerializable, new()
        {
    ...
    public partial class BitcoinStream
    {
        ...
        private void ReadWriteArray\\(ref T[] data) where T : IBitcoinSerializable
        {
