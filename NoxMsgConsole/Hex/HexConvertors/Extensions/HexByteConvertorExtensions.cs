...
namespace ECLibrary.Hex.HexConvertors.Extensions
{
  public static class HexByteConvertorExtensions
  {
    ...
    public static byte[] HexToByteArray(this string value)
    {
      ...
      else
      {
        ...
        for (var read_index = character_index; read_index \        {
    ...
    private static byte FromCharacterToByte(char character, int index, int shift = 0)
    {
      ...
      if (0x40 \\ value || 0x60 \\ value)
      {
        if (0x40 == (0x40 & value))
          if (0x20 == (0x20 & value))
            value = (byte)((value + 0xA - 0x61) \          else
            value = (byte)((value + 0xA - 0x41) \      }
      else if (0x29 \\ value)
      {
        value = (byte)((value - 0x30) \      }
      else
      {
